...
class CardDao {
    static findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return card_model_1.default.findAll();
        });
    }
    static findOne(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return card_model_1.default.findByPk(id);
        });
    }
    ...
    static findByEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            return card_model_1.default.findOne({ where: { email } });
        });
    }
    ...
    static remove(id) {
        return __awaiter(this, void 0, void 0, function* () {
            card_model_1.default.findByPk(id).then(data => data === null || data === void 0 ? void 0 : data.destroy);
        });
    }
}
